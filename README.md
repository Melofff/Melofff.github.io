...
|:----:|:----:|
|시작화면|시작 버튼, 종료 버튼 존재<br>시작 버튼 - 게임 화면으로 이동<br>종료 버튼 - 게임 종료<br>|
|게임 화면|현재 체력, 스태미나, 무기를 좌상단에 표시<br>중앙에 플레이어 캐릭터 표시<br>스테이지는 총 5가지<br>중앙 스테이지 기준 0,90,180,270도 방향마다 각 스테이로 향하는 문 존재<br>조작은 WASD - 이동, 마우스 좌클릭 – 공격, 마우스 이동 – 시점 회전<br>스페이스바 - 회피, E키 – 물약 사용<br>Esc키 – 게임 종료 버튼 표시, 버튼 클릭시 게임 저장 및 종료<br>평소엔 마우스를 숨기지만 esc를 누르면 마우스를 표시|
|클리어 ||
